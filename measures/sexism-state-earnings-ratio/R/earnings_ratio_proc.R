## -------------------------------------------------------
#
# earnings_ratio_proc.R
#
# Process the male and female median usual weekly earnings of full-time
# wage and salary workers to compute the earnings ratio between
# males and females for each year from 2015 to 2021 by state. 
#
## -------------------------------------------------------

## ---- Establish location of current script ----
here::i_am("measures/sexism-state-earnings-ratio/R/earnings_ratio_proc.R")
...
topic <- "sexism-state-earnings-ratio"
...
df <- df |> 
  ...
  select(year, statefips, state, ratio_earnings, -postal) |> 
