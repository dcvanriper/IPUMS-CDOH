## -------------------------------------------------------
#
# racism_county_employment_inequity_extract.R
#
# Generate request and download data tables for employment
# attainment by race for all ACS 5-year datasets. 
#
## -------------------------------------------------------

## ---- Establish location of current script ----
here::i_am("measures/racism-county-employment-inequity/R/racism_county_employment_inequity_extract.R")
...
topic <- "racism-county-employment-inequity"

# Data tables
tables = c("C23002H", "C23002B", "C23002I", "C23002D")
