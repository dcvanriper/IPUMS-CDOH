## -------------------------------------------------------
#
# racism_county_educational_inequity_extract.R
#
# Generate request and download data tables for educational
# attainment by race for all ACS 5-year datasets. 
#
## -------------------------------------------------------

## ---- Establish location of current script ----
here::i_am("measures/racism-county-educational-inequity/R/racism_county_educational_inequity_extract.R")
...
# Data tables
tables = c("C15002H", "C15002B", "C15002I", "C15002D")
