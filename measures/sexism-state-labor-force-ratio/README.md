...
The input data for the labor force ratio measure are the same as those for the earnings ratio measure. If you have already downloaded the data for the labor force ratio, you can copy the Excel spreadsheets from the earnings ratio `/data/input` directory to the labor force ratio `/data/input` directory. 
