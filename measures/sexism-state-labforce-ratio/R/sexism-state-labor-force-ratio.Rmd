...
### Temporal Extent
Data are available in machine-readable format from 2015-2021. Data from 1998-2014 are only available in PDF. We compute the state-level labor force ratios for 2015-2021 using the machine-readable data.   
...
* Claire Kamp Dush, Wendy Manning, and David Van Riper. Sexism - state - labor force ratio. IPUMS Contextual Determinants of Health. Minneapolis, MN: IPUMS. 2023. https://doi.org/10.18128/M130-002.2023-04
